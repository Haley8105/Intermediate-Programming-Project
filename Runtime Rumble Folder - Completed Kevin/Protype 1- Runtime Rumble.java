...
class Game extends JPanel implements Runnable, KeyListener {
    ...
    private static Clip jumpClip, punchClip, kickClip, backgroundMusicClip, menuMusicClip;
    ...
    public void loadSounds() {
        ...
        try {
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File(basePath + "tatamusic-battle-warrior-fighting-drums-478210.wav"));
